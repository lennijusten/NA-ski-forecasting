...
# TODO get WETBULB folder made at '/adhara_a/emaroon/cesmLE1/atm/proc/tseries/daily/'

# Example input
a = ['b.e11.B20TRC5CNBDRD.f09_g16.001.cam.h1.TREFHT.18500101-20051231.nc',
     'b.e11.BRCP85C5CNBDRD.f09_g16.001.cam.h1.TREFHT.20060101-20801231.nc',
     'b.e11.BRCP85C5CNBDRD.f09_g16.001.cam.h1.TREFHT.20810101-21001231.nc',
     'b.e11.B20TRC5CNBDRD.f09_g16.001.cam.h1.QBOT.18500101-20051231.nc',
     'b.e11.BRCP85C5CNBDRD.f09_g16.001.cam.h1.QBOT.20060101-20801231.nc',
     'b.e11.BRCP85C5CNBDRD.f09_g16.001.cam.h1.QBOT.20810101-21001231.nc',
     'b.e11.B20TRC5CNBDRD.f09_g16.001.cam.h0.PS.185001-200512.nc,'
     'b.e11.BRCP85C5CNBDRD.f09_g16.001.cam.h1.WETBULB.18500101-21001231.nc']
...
def init_data(f_temp, f_qbot, f_press):  # pass as lists
...
temp_degC = temp1['TREFHT'].values - 273.15
...
for i in range(len(long_temp)):
    ...
    wetbulb_search.append(wetbulb_key[p_idx][dp_idx][t_idx])
